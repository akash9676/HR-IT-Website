                ...
                <div className="flex flex-col md:flex-row items-center">
                    <div className="md:w-1/2 mb-8 md:mb-0 md:mr-8 ">
                        ...
                        <h1 className="text-4xl md:text-5xl font-bold mb-4">
                            ...
                            <span className="relative whitespace-nowrap text-orange-500 dark:text-orange-500">
                                <svg
                                    aria-hidden="true"
                                    viewBox="0 0 418 42"
                                    className="absolute top-2/3 left-0 h-[0.58em] w-full fill-orange-500 dark:fill-orange-300"
